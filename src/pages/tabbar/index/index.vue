<template>
  <view class="content">
    <view class="component-list">
      ...
      >
        <ItemDisplay
          v-if="template.class === 'item-display'"
          :data="template.data"
        />
        <SearchText
          v-if="template.class === 'search-text'"
          :data="template.data"
        />
        <AllRights
          v-if="template.class === 'all-rights'"
          :data="template.data"
        />
        ...
        <NearbyStores
          v-if="template.class === 'nearby-stores'"
          :data="template.data"
        />
        <Notice v-if="template.class === 'notice'" :data="template.data" />
        <SalesPromotion
          v-if="template.class === 'sales-promotion'"
          :data="template.data"
        />
        ...
        list: [
          {
            ...
            count: 6435,
            img:
              "http://img.tecqm.cn/qm-platform/sharp_39bbcbc2e5ef4f52959073220417e1c2.png",
          },
          {
            id: "sdfsdfsdfsdf",
            name: "商品1",
